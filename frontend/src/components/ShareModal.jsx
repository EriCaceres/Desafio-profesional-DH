...
export default function ShareModal({ isOpen, onClose, product }) {
  ...
  // Mensaje por defecto
  const defaultMessage = `¡Mirá este servicio de detailing! ${product.name}`;
    ...
    <div className="share-modal-overlay" onClick={onClose}>
      <div className="share-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="share-modal__header">
          <h2 className="share-modal__title">Compartir servicio</h2>
        ...
        <div className="share-modal__product">
          <div className="share-modal__product-info">
            <h3 className="share-modal__product-name">{product.name}</h3>
            <p className="share-modal__product-desc">
              {product.description?.substring(0, 80)}...
            </p>
            {product.priceFrom && (
              <span className="share-modal__product-price">
        ...
        <div className="share-modal__link">
          <input
            ...
            readOnly
          />
          <button className="share-modal__copy" onClick={handleCopyLink}>
            Copiar link
          </button>
        </div>
      </div>
